/**
 * Gitee Plugin — Vue Composable
 *
 * Bridges GiteeFeature to Vue reactivity.
 * No Core/Registry/Service access.
 */

import { ref, computed } from 'vue'
import { createFeatureContext } from '@/sdk/feature'
import { GiteeFeature } from './GiteeFeature'
import { createToolbar } from './toolbar'
import { defaults } from './settings'
import type { GiteeConfig } from './types'

export function useGitee() {
  // Context & Feature
  ...
  const feature = new GiteeFeature(context)
