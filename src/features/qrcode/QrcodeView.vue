...
/**
 * Qrcode Plugin — Main View (viewer template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useQrcode()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">Qrcode</h1>
      <p class="page-desc">查看器工具 — 预览文件和元数据 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
    ...
    <div class="page-content">
      ...
      <div class="card" v-if="!output && !error && !input">
        <div class="card-body empty-hint">
          <p>👁 查看器工具 — 预览文件和元数据</p>
          <p class="hint-desc">输入内容后点击「打开」或按 <kbd>⌘Enter</kbd></p>
        </div>
      </div>
    </div>
  </div>
