...
> Auto-generated by Plugin Generator. Template: `viewer`
...
```
features/qrcode/
├── QrcodeFeature.ts    ← Feature class (extends BaseFeature)
...
├── QrcodeView.vue       ← Main view
├── index.ts              ← Public API
└── __tests__/
    └── logic.test.ts     ← Unit tests

plugins/qrcode.plugin.ts ← Plugin manifest
```
