/**
 * Sm3 Plugin — Vue Composable
 *
 * Bridges Sm3Feature to Vue reactivity.
...
import { Sm3Feature } from './Sm3Feature'
import { createToolbar } from './toolbar'
import { defaults } from './settings'
import type { Sm3Config } from './types'

export function useSm3() {
  // Context & Feature
  const context = createFeatureContext<Sm3Config>({
    id: 'sm3',
    name: 'Sm3',
  ...
  const feature = new Sm3Feature(context)
