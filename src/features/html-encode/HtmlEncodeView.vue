...
/**
 * HtmlEncode Plugin — Main View (transform template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useHtmlEncode()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">HtmlEncode</h1>
