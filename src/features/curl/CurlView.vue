...
/**
 * Curl Plugin — Main View (network template)
 *
...
import { useCurl } from './composables'
import { usePointerSafeAction } from '@/composables/usePointerSafeAction'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useCurl()
