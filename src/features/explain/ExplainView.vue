...
/**
 * Explain Plugin — Main View (ai template)
 *
...
import { useExplain } from './composables'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useExplain()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">Explain</h1>
      <p class="page-desc">AI 工具 — 对话、补全与生成 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
