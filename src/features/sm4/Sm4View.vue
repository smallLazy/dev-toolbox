...
/**
 * Sm4 Plugin — Main View (transform template)
 *
...
import { useSm4 } from './composables'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useSm4()
