/**
 * DiffFeature — Auto-generated by Plugin Generator
 *
 * Template: editor
...
export class DiffFeature extends BaseFeature<DiffConfig, string, string> {
  ...
  get toolState(): Readonly<DiffState> { return this._toolState }
  ...
  async activate(): Promise<void> {
    ...
    this.context.notification.info('Diff', 'Ready — Editor tool — format, minify, and validate')
  }
  ...
  // ── Core Logic ────────────────────────────────────────────────────
  async run(input: string, config: DiffConfig): Promise<string> {
  ...
  preview(_input: string, _config: DiffConfig): string | null { return null }
