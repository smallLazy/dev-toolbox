/**
 * Jira Plugin — Vue Composable
 *
 * Bridges JiraFeature to Vue reactivity.
...
import { JiraFeature } from './JiraFeature'
...
export function useJira() {
  // Context & Feature
  const context = createFeatureContext<JiraConfig>({
    id: 'jira',
    name: 'Jira',
  ...
  const feature = new JiraFeature(context)
