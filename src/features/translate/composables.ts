/**
 * Translate Plugin — Vue Composable
 *
 * Bridges TranslateFeature to Vue reactivity.
...
export function useTranslate() {
  // Context & Feature
  const context = createFeatureContext<TranslateConfig>({
    id: 'translate',
    name: 'Translate',
  ...
  const feature = new TranslateFeature(context)
