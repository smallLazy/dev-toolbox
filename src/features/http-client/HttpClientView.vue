...
/**
 * HttpClient Plugin — Main View (network template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useHttpClient()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">HttpClient</h1>
