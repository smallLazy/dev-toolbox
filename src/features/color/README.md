...
> Auto-generated by Plugin Generator. Template: `converter`
...
```
features/color/
├── ColorFeature.ts    ← Feature class (extends BaseFeature)
...
├── ColorView.vue       ← Main view
├── index.ts              ← Public API
└── __tests__/
    └── logic.test.ts     ← Unit tests

plugins/color.plugin.ts ← Plugin manifest
```
