...
/**
 * Color Plugin — Main View (converter template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useColor()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      ...
      <p class="page-desc">格式互转工具 — 两种格式之间互相转换 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
    ...
    <div class="page-content">
      ...
      <div class="card" v-if="!output && !error && !input">
        <div class="card-body empty-hint">
          <p>🔄 格式互转工具 — 两种格式之间互相转换</p>
          <p class="hint-desc">输入内容后点击「转换」或按 <kbd>⌘Enter</kbd></p>
        </div>
      </div>
    </div>
  </div>
