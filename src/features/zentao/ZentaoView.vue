...
/**
 * Zentao Plugin — Main View (enterprise template)
 *
...
import { useZentao } from './composables'
import { usePointerSafeAction } from '@/composables/usePointerSafeAction'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useZentao()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">Zentao</h1>
      <p class="page-desc">企业工具 — 外部服务集成 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
