/**
 * Graphql Plugin — Vue Composable
 *
 * Bridges GraphqlFeature to Vue reactivity.
...
import { GraphqlFeature } from './GraphqlFeature'
...
export function useGraphql() {
  ...
  const feature = new GraphqlFeature(context)
