...
/**
 * Graphql Plugin — Main View (network template)
 *
...
import { useGraphql } from './composables'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useGraphql()
