...
import { useYaml } from './composables'
...
const { input, output, error, loading, toolbar, execute, init, dispose } = useYaml()
...
<template>
  <ToolLayout
    title="YAML"
    description="Format, minify, and validate YAML."
