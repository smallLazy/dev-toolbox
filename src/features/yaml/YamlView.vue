...
/**
 * Yaml Plugin — Main View (editor template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useYaml()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">Yaml</h1>
      <p class="page-desc">编辑器工具 — 格式化、压缩与验证 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
    ...
    <div class="page-content">
      ...
      <div class="card" v-if="!output && !error && !input">
        <div class="card-body empty-hint">
          <p>编辑器工具 — 格式化、压缩与验证</p>
          <p class="hint-desc">输入内容后点击「格式化」或按 <kbd>⌘Enter</kbd></p>
        </div>
      </div>
    </div>
  </div>
