...
/**
 * RequestDecoder Plugin — Main View (network template)
 *
...
import { useRequestDecoder } from './composables'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useRequestDecoder()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">RequestDecoder</h1>
      <p class="page-desc">网络工具 — HTTP 请求与响应分析 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
    ...
    <div class="page-content">
      ...
      <div class="card" v-if="!output && !error && !input">
        <div class="card-body empty-hint">
          <p>🌐 网络工具 — HTTP 请求与响应分析</p>
          <p class="hint-desc">输入内容后点击「发送」或按 <kbd>⌘Enter</kbd></p>
        </div>
      </div>
    </div>
  </div>
