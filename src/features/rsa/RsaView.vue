...
/**
 * Rsa Plugin — Main View (transform template)
 *
...
import { useRsa } from './composables'
import { usePointerSafeAction } from '@/composables/usePointerSafeAction'

const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useRsa()
