...
/**
 * Regex Plugin — Main View (inspector template)
 *
...
const { input, output, error, loading, stats, toolbar, execute, init, dispose } = useRegex()
...
<template>
  <div class="page" @keydown="onKeydown">
    <header class="page-header">
      <h1 class="page-title">Regex</h1>
      <p class="page-desc">检查器工具 — 解析并结构化展示数据 &mdash; <kbd>⌘Enter</kbd> 执行</p>
    </header>
    ...
    <div class="page-content">
      ...
      <div class="card" v-if="!output && !error && !input">
        <div class="card-body empty-hint">
          <p>检查器工具 — 解析并结构化展示数据</p>
          <p class="hint-desc">输入内容后点击「解析」或按 <kbd>⌘Enter</kbd></p>
        </div>
      </div>
    </div>
  </div>
